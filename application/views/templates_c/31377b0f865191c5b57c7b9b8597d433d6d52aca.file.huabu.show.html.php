<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-24 04:12:14
         compiled from "application\views\templates\huabu.show.html" */ ?>
<?php /*%%SmartyHeaderCode:320595510d60e2b1a38-40693350%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31377b0f865191c5b57c7b9b8597d433d6d52aca' => 
    array (
  ...
  'nocache_hash' => '320595510d60e2b1a38-40693350',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5510d60e4c2161_44913141',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5510d60e4c2161_44913141')) {function content_5510d60e4c2161_44913141($_smarty_tpl) {?><!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="h_main">
	...
	<h1><?php if ($_smarty_tpl->tpl_vars['data']->value['Subject']) {
...
<a title="更多平台" class="bshare-more bshare-more-icon more-style-addthis"></a></div><?php echo '<script'; ?>
 src="http://static.bshare.cn/b/buttonLite.js#style=-1&amp;uuid=2c9fb966-ed24-4cd7-aba5-55671695e3b4&amp;pophcol=1&amp;lang=zh" type="text/javascript" charset="utf-8"><?php echo '</script'; ?>
><?php echo '<script'; ?>
 src="http://static.bshare.cn/b/bshareC0.js" type="text/javascript" charset="utf-8"><?php echo '</script'; ?>
> 
...
"></div> 
       ...
       <!-- 内容 start -->
            <div class="cont">
               ...
               <?php if ($_smarty_tpl->tpl_vars['pinglun']->value['Uid']==$_smarty_tpl->tpl_vars['user']->value['Uid']) {
} else { ?>
...
"></div> 
                <div class="cont">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['pinglunChild']->value['Uid']==$_smarty_tpl->tpl_vars['user']->value['Uid']) {
} else { ?>
...
public/js/comment.js"><?php echo '</script'; ?>
>
